...
<div id="sidebar" class="active">
  ...
  <ul class="sidebar_nav">
    ...
    <a href="#"><li><span class="icon" style="background: url('assets/img/pencil.svg');background-position: center;background-repeat:no-repeat;background-size: cover;"></span> give test</li></a>
